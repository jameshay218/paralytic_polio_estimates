...
OPV_cov_2 <- coverage_1*vax_profile$OPV.at.age.2 # coverage with OPV at age 2
OPV_cov_5 <- (coverage_2-coverage_1)*vax_profile$OPV.at.age.5 # coverage with IPV at age 5
...
stage_age_vax[,,2] <- t( LPV_birth*t(sapply(ages,immune_stage_dist))+ OPV_cov_2*t(sapply(ages-2,immune_stage_dist))+ OPV_cov_5*t(sapply(ages-5,immune_stage_dist)) )
