...
priors <- read_csv("pars/priors - alt low coverage scenario.csv")
tmp_pars <- priors
...
ggsave(filename = paste0(main_wd,"/figures/prior_distributions_alt_low_coverage.pdf"),p_prior,height=8,width=8)
